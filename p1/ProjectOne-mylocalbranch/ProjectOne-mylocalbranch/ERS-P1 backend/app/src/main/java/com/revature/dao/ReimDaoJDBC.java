...
public class ReimDaoJDBC implements IReimDao {
    ...
    public void createReim(Reimbursement r) {
        ...
        String sql = "insert into reimbursement (amount, description,submitted_date, reimbursement_author, reimbursement_type) values " +
                "("+r.getAmount()+", '"+r.getDescription()+"', '"+r.getSubmitted_date()+"',"+r.getReimbursement_author()+", "+r.getReimbursement_type()+");";
